...
class Google_Service_Analytics_Goal extends \ahrefs\AhrefsSeoKit\Google_Model
{
    public $accountId;
    public $active;
    public $created;
     ...
     */
    public function setEventDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GoalEventDetails $eventDetails)
    {
     ...
     */
    public function setParentLink(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GoalParentLink $parentLink)
    {
     ...
     */
    public function setUrlDestinationDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GoalUrlDestinationDetails $urlDestinationDetails)
    {
     ...
     */
    public function setVisitNumPagesDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GoalVisitNumPagesDetails $visitNumPagesDetails)
    {
     ...
     */
    public function setVisitTimeOnSiteDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GoalVisitTimeOnSiteDetails $visitTimeOnSiteDetails)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Goal', 'Google_Service_Analytics_Goal', \false);
