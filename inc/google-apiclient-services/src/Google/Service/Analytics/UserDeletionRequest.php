...
class Google_Service_Analytics_UserDeletionRequest extends \ahrefs\AhrefsSeoKit\Google_Model
{
     ...
     */
    public function setId(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_UserDeletionRequest', 'Google_Service_Analytics_UserDeletionRequest', \false);
