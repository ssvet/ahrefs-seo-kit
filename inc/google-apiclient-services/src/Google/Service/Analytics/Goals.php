...
class Google_Service_Analytics_Goals extends \ahrefs\AhrefsSeoKit\Google_Collection
{
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Goals', 'Google_Service_Analytics_Goals', \false);
