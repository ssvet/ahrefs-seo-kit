...
class Google_Service_Analytics_Webproperty extends \ahrefs\AhrefsSeoKit\Google_Model
{
    public $accountId;
     ...
     */
    public function setChildLink(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_WebpropertyChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_WebpropertyParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_WebpropertyPermissions $permissions)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Webproperty', 'Google_Service_Analytics_Webproperty', \false);
