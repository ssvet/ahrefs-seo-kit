...
class Google_Service_Analytics_CustomDataSource extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setChildLink(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomDataSourceChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomDataSourceParentLink $parentLink)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_CustomDataSource', 'Google_Service_Analytics_CustomDataSource', \false);
