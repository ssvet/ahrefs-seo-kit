...
class Google_Service_Analytics_Filter extends \ahrefs\AhrefsSeoKit\Google_Model
{
    public $accountId;
     ...
     */
    public function setAdvancedDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterAdvancedDetails $advancedDetails)
    {
     ...
     */
    public function setExcludeDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterExpression $excludeDetails)
    {
     ...
     * @param Google_Service_Analytics_FilterExpression
     */
    public function setIncludeDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterExpression $includeDetails)
    {
     ...
     */
    public function setLowercaseDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterLowercaseDetails $lowercaseDetails)
    {
     ...
     */
    public function setParentLink(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterParentLink $parentLink)
    {
     ...
     */
    public function setSearchAndReplaceDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterSearchAndReplaceDetails $searchAndReplaceDetails)
    {
     ...
     */
    public function setUppercaseDetails(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_FilterUppercaseDetails $uppercaseDetails)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Filter', 'Google_Service_Analytics_Filter', \false);
