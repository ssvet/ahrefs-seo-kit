...
class Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition extends \ahrefs\AhrefsSeoKit\Google_Model
{
     ...
     */
    public function setExcludeConditions(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinitionExcludeConditions $excludeConditions)
    {
     ...
     */
    public function setIncludeConditions(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_IncludeConditions $includeConditions)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition', 'Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition', \false);
