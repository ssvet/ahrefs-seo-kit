...
class Google_Service_Analytics_RealtimeData extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setProfileInfo(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_RealtimeDataProfileInfo $profileInfo)
    {
     ...
     */
    public function setQuery(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_RealtimeDataQuery $query)
    {
        $this->query = $query;
    }
    /**
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_RealtimeData', 'Google_Service_Analytics_RealtimeData', \false);
