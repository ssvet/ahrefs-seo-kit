...
class Google_Service_Analytics_AccountTreeResponse extends \ahrefs\AhrefsSeoKit\Google_Model
{
     ...
     */
    public function setAccount(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_Account $account)
    {
     ...
     */
    public function setProfile(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_Profile $profile)
    {
     ...
     */
    public function setWebproperty(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_Webproperty $webproperty)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_AccountTreeResponse', 'Google_Service_Analytics_AccountTreeResponse', \false);
