...
class Google_Service_Analytics_McfData extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setProfileInfo(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_McfDataProfileInfo $profileInfo)
    {
     ...
     */
    public function setQuery(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_McfDataQuery $query)
    {
        $this->query = $query;
    }
    /**
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_McfData', 'Google_Service_Analytics_McfData', \false);
