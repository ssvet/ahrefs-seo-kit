 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_Provisioning extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     */
    public function createAccountTicket(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_AccountTicket $postBody, $optParams = array())
    {
     ...
     */
    public function createAccountTree(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_AccountTreeRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_Provisioning', 'Google_Service_Analytics_Resource_Provisioning', \false);
