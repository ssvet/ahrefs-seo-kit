 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementCustomMetrics extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_CustomMetric
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomMetric
     */
    public function patch($accountId, $webPropertyId, $customMetricId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomMetric
     */
    public function update($accountId, $webPropertyId, $customMetricId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_ManagementCustomMetrics', 'Google_Service_Analytics_Resource_ManagementCustomMetrics', \false);
