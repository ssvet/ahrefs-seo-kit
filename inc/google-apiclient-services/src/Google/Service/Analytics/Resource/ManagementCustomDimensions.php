 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementCustomDimensions extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_CustomDimension
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomDimension
     */
    public function patch($accountId, $webPropertyId, $customDimensionId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomDimension
     */
    public function update($accountId, $webPropertyId, $customDimensionId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_CustomDimension $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_ManagementCustomDimensions', 'Google_Service_Analytics_Resource_ManagementCustomDimensions', \false);
