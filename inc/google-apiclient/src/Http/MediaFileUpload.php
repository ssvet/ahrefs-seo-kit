...
use ahrefs\AhrefsSeoKit\Google\Exception as GoogleException;
use GuzzleHttp\Psr7;
...
class MediaFileUpload
{
     ...
     */
    public function __construct(\ahrefs\AhrefsSeoKit\Google\Client $client, \Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = \false)
    {
        $this->client = $client;
    ...
    public function nextChunk($chunk = \false)
    {
        ...
        $request = new \GuzzleHttp\Psr7\Request('PUT', $resumeUri, $headers, \GuzzleHttp\Psr7\stream_for($chunk));
     ...
     *
     */
    private function makePutRequest(\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return \ahrefs\AhrefsSeoKit\Google\Http\REST::decodeHttpResponse($response, $this->request);
    }
    /**
    ...
    public function resume($resumeUri)
    {
        ...
        $httpRequest = new \GuzzleHttp\Psr7\Request('PUT', $this->resumeUri, $headers);
    ...
    private function process()
    {
        ...
        $request = $request->withUri(\GuzzleHttp\Psr7\Uri::withQueryValue($request->getUri(), 'uploadType', $uploadType));
        ...
        $request = $request->withBody(\GuzzleHttp\Psr7\stream_for($postBody));
    ...
    private function fetchResumeUri()
    {
        ...
        throw new \ahrefs\AhrefsSeoKit\Google\Exception($error);
    }
    private function transformToUploadUrl()
    {
        ...
        $uri = \GuzzleHttp\Psr7\Uri::fromParts($parts);
