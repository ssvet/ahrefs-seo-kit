...
use ahrefs\AhrefsSeoKit\Google\Auth\ServiceAccountSignerTrait;
 ...
 */
class ServiceAccountCredentials extends \ahrefs\AhrefsSeoKit\Google\Auth\CredentialsLoader implements \ahrefs\AhrefsSeoKit\Google\Auth\GetQuotaProjectInterface, \ahrefs\AhrefsSeoKit\Google\Auth\SignBlobInterface, \ahrefs\AhrefsSeoKit\Google\Auth\ProjectIdProviderInterface
{
    ...
    public function __construct($scope, $jsonKey, $sub = null, $targetAudience = null)
    {
        ...
        $this->auth = new \ahrefs\AhrefsSeoKit\Google\Auth\OAuth2(['audience' => self::TOKEN_CREDENTIAL_URI, 'issuer' => $jsonKey['client_email'], 'scope' => $scope, 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'sub' => $sub, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI, 'additionalClaims' => $additionalClaims]);
    ...
    public function updateMetadata($metadata, $authUri = null, callable $httpHandler = null)
    {
        ...
        $jwtCreds = new \ahrefs\AhrefsSeoKit\Google\Auth\Credentials\ServiceAccountJwtAccessCredentials($credJson);
