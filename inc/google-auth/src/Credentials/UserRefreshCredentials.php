 ...
 */
class UserRefreshCredentials extends \ahrefs\AhrefsSeoKit\Google\Auth\CredentialsLoader implements \ahrefs\AhrefsSeoKit\Google\Auth\GetQuotaProjectInterface
{
    /**
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->auth = new \ahrefs\AhrefsSeoKit\Google\Auth\OAuth2(['clientId' => $jsonKey['client_id'], 'clientSecret' => $jsonKey['client_secret'], 'refresh_token' => $jsonKey['refresh_token'], 'scope' => $scope, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI]);
