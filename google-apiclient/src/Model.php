...
class Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \ahrefs\AhrefsSeoKit\Google\Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \ahrefs\AhrefsSeoKit\Google\Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
