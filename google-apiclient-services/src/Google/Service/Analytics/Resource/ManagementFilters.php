 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementFilters extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Filter
     */
    public function insert($accountId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Filter
     */
    public function patch($accountId, $filterId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Filter
     */
    public function update($accountId, $filterId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'filterId' => $filterId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_ManagementFilters', 'Google_Service_Analytics_Resource_ManagementFilters', \false);
