 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementWebPropertyAdWordsLinks extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_EntityAdWordsLink
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityAdWordsLink
     */
    public function patch($accountId, $webPropertyId, $webPropertyAdWordsLinkId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityAdWordsLink
     */
    public function update($accountId, $webPropertyId, $webPropertyAdWordsLinkId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'webPropertyAdWordsLinkId' => $webPropertyAdWordsLinkId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_ManagementWebPropertyAdWordsLinks', 'Google_Service_Analytics_Resource_ManagementWebPropertyAdWordsLinks', \false);
