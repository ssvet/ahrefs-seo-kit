 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementGoals extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Goal
     */
    public function insert($accountId, $webPropertyId, $profileId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Goal
     */
    public function patch($accountId, $webPropertyId, $profileId, $goalId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Goal
     */
    public function update($accountId, $webPropertyId, $profileId, $goalId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_ManagementGoals', 'Google_Service_Analytics_Resource_ManagementGoals', \false);
