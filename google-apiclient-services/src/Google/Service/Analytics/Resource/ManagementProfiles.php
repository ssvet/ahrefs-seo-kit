 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementProfiles extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Profile
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Profile
     */
    public function patch($accountId, $webPropertyId, $profileId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Profile
     */
    public function update($accountId, $webPropertyId, $profileId, \ahrefs\AhrefsSeoKit\Google_Service_Analytics_Profile $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Resource_ManagementProfiles', 'Google_Service_Analytics_Resource_ManagementProfiles', \false);
