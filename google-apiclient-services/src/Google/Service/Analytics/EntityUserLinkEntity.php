...
class Google_Service_Analytics_EntityUserLinkEntity extends \ahrefs\AhrefsSeoKit\Google_Model
{
     ...
     */
    public function setAccountRef(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_AccountRef $accountRef)
    {
     ...
     */
    public function setProfileRef(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_ProfileRef $profileRef)
    {
     ...
     */
    public function setWebPropertyRef(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_WebPropertyRef $webPropertyRef)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_EntityUserLinkEntity', 'Google_Service_Analytics_EntityUserLinkEntity', \false);
