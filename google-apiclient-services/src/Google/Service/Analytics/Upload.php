...
class Google_Service_Analytics_Upload extends \ahrefs\AhrefsSeoKit\Google_Collection
{
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_Upload', 'Google_Service_Analytics_Upload', \false);
