...
class Google_Service_Analytics_GaData extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setDataTable(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GaDataDataTable $dataTable)
    {
     ...
     */
    public function setProfileInfo(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GaDataProfileInfo $profileInfo)
    {
     ...
     */
    public function setQuery(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_GaDataQuery $query)
    {
        $this->query = $query;
    }
    /**
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_GaData', 'Google_Service_Analytics_GaData', \false);
