...
class Google_Service_Analytics_EntityUserLink extends \ahrefs\AhrefsSeoKit\Google_Model
{
     ...
     */
    public function setEntity(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_EntityUserLinkEntity $entity)
    {
        $this->entity = $entity;
    }
    /**
     ...
     */
    public function setPermissions(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_EntityUserLinkPermissions $permissions)
    {
     ...
     */
    public function setUserRef(\ahrefs\AhrefsSeoKit\Google_Service_Analytics_UserRef $userRef)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_Analytics_EntityUserLink', 'Google_Service_Analytics_EntityUserLink', \false);
