...
class Google_Service_AnalyticsData_RunPivotReportResponse extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setMetadata(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_ResponseMetaData $metadata)
    {
     ...
     */
    public function setPropertyQuota(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_PropertyQuota $propertyQuota)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_AnalyticsData_RunPivotReportResponse', 'Google_Service_AnalyticsData_RunPivotReportResponse', \false);
