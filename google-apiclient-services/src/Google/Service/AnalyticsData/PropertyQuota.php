...
class Google_Service_AnalyticsData_PropertyQuota extends \ahrefs\AhrefsSeoKit\Google_Model
{
     ...
     */
    public function setConcurrentRequests(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_QuotaStatus $concurrentRequests)
    {
     ...
     * @param Google_Service_AnalyticsData_QuotaStatus
     */
    public function setServerErrorsPerProjectPerHour(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_QuotaStatus $serverErrorsPerProjectPerHour)
    {
     ...
     * @param Google_Service_AnalyticsData_QuotaStatus
     */
    public function setTokensPerDay(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_QuotaStatus $tokensPerDay)
    {
     ...
     * @param Google_Service_AnalyticsData_QuotaStatus
     */
    public function setTokensPerHour(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_QuotaStatus $tokensPerHour)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_AnalyticsData_PropertyQuota', 'Google_Service_AnalyticsData_PropertyQuota', \false);
