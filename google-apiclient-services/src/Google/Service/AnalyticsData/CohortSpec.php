...
class Google_Service_AnalyticsData_CohortSpec extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setCohortReportSettings(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_CohortReportSettings $cohortReportSettings)
    {
     ...
     */
    public function setCohortsRange(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_CohortsRange $cohortsRange)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_AnalyticsData_CohortSpec', 'Google_Service_AnalyticsData_CohortSpec', \false);
