 ...
 *  </code>
 */
class Google_Service_AnalyticsData_Resource_V1alpha extends \ahrefs\AhrefsSeoKit\Google_Service_Resource
{
    /**
     ...
     */
    public function batchRunPivotReports(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_BatchRunPivotReportsRequest $postBody, $optParams = array())
    {
     ...
     */
    public function batchRunReports(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_BatchRunReportsRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     */
    public function runPivotReport(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_RunPivotReportRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
     ...
     */
    public function runReport(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_RunReportRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_AnalyticsData_Resource_V1alpha', 'Google_Service_AnalyticsData_Resource_V1alpha', \false);
