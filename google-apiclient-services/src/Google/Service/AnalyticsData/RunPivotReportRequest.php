...
class Google_Service_AnalyticsData_RunPivotReportRequest extends \ahrefs\AhrefsSeoKit\Google_Collection
{
     ...
     */
    public function setCohortSpec(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_CohortSpec $cohortSpec)
    {
     ...
     */
    public function setDimensionFilter(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_FilterExpression $dimensionFilter)
    {
     ...
     * @param Google_Service_AnalyticsData_FilterExpression
     */
    public function setMetricFilter(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_FilterExpression $metricFilter)
    {
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_AnalyticsData_RunPivotReportRequest', 'Google_Service_AnalyticsData_RunPivotReportRequest', \false);
