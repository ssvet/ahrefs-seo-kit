...
class Google_Service_AnalyticsData_OrderBy extends \ahrefs\AhrefsSeoKit\Google_Model
{
    public $desc;
     ...
     */
    public function setDimension(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_DimensionOrderBy $dimension)
    {
     ...
     */
    public function setMetric(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_MetricOrderBy $metric)
    {
        $this->metric = $metric;
    }
    /**
     ...
     */
    public function setPivot(\ahrefs\AhrefsSeoKit\Google_Service_AnalyticsData_PivotOrderBy $pivot)
    {
        $this->pivot = $pivot;
    }
    /**
 ...
 * the License.
 */
\class_alias('ahrefs\\AhrefsSeoKit\\Google_Service_AnalyticsData_OrderBy', 'Google_Service_AnalyticsData_OrderBy', \false);
