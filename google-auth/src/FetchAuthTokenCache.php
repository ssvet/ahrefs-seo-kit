 ...
 */
class FetchAuthTokenCache implements \ahrefs\AhrefsSeoKit\Google\Auth\FetchAuthTokenInterface, \ahrefs\AhrefsSeoKit\Google\Auth\GetQuotaProjectInterface, \ahrefs\AhrefsSeoKit\Google\Auth\SignBlobInterface, \ahrefs\AhrefsSeoKit\Google\Auth\ProjectIdProviderInterface, \ahrefs\AhrefsSeoKit\Google\Auth\UpdateMetadataInterface
{
    use CacheTrait;
    /**
     ...
     */
    public function __construct(\ahrefs\AhrefsSeoKit\Google\Auth\FetchAuthTokenInterface $fetcher, array $cacheConfig = null, \Psr\Cache\CacheItemPoolInterface $cache)
    {
    ...
    {
        if (!$this->fetcher instanceof \ahrefs\AhrefsSeoKit\Google\Auth\SignBlobInterface) {
    ...
    {
        if ($this->fetcher instanceof \ahrefs\AhrefsSeoKit\Google\Auth\GetQuotaProjectInterface) {
    ...
    {
        if (!$this->fetcher instanceof \ahrefs\AhrefsSeoKit\Google\Auth\ProjectIdProviderInterface) {
    ...
    {
        if (!$this->fetcher instanceof \ahrefs\AhrefsSeoKit\Google\Auth\UpdateMetadataInterface) {
