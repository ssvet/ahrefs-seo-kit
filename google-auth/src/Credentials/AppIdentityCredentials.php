 ...
 */
use ahrefs\AhrefsSeoKit\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \ahrefs\AhrefsSeoKit\Google\Auth\CredentialsLoader implements \ahrefs\AhrefsSeoKit\Google\Auth\SignBlobInterface, \ahrefs\AhrefsSeoKit\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \ahrefs\AhrefsSeoKit\google\appengine\api\app_identity\AppIdentityService::getAccessToken($scope);
    ...
    {
        $this->checkAppEngineContext();
        return \base64_encode(\ahrefs\AhrefsSeoKit\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHander = null)
    {
        ...
        return \ahrefs\AhrefsSeoKit\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        $this->checkAppEngineContext();
        if (!$this->clientName) {
            $this->clientName = \ahrefs\AhrefsSeoKit\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('ahrefs\\AhrefsSeoKit\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
