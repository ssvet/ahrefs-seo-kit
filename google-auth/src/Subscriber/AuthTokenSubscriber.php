...
namespace ahrefs\AhrefsSeoKit\Google\Auth\Subscriber;

use ahrefs\AhrefsSeoKit\Google\Auth\FetchAuthTokenInterface;
...
class AuthTokenSubscriber implements \GuzzleHttp\Event\SubscriberInterface
{
     ...
     */
    public function __construct(\ahrefs\AhrefsSeoKit\Google\Auth\FetchAuthTokenInterface $fetcher, callable $httpHandler = null, callable $tokenCallback = null)
    {
    ...
    {
        return ['before' => ['onBefore', \GuzzleHttp\Event\RequestEvents::SIGN_REQUEST]];
    }
    /**
    ...
    public function onBefore(\GuzzleHttp\Event\BeforeEvent $event)
    {
        ...
        if ($quotaProject = $this->getQuotaProject()) {
            $request->setHeader(\ahrefs\AhrefsSeoKit\Google\Auth\GetQuotaProjectInterface::X_GOOG_USER_PROJECT_HEADER, $quotaProject);
        }
    }
